...
function createPopupOne() {
    ...
    popupCard.querySelector('.popup-text').innerHTML = pets[activeOrderOne].description;
    popupCard.querySelector('.age').innerHTML = pets[activeOrderOne].age;
    popupCard.querySelector('.inoc').innerHTML = pets[activeOrderOne].inoculations;
    popupCard.querySelector('.diseas').innerHTML = pets[activeOrderOne].diseases;
    popupCard.querySelector('.parasite').innerHTML = pets[activeOrderOne].parasites;
}
...
function createPopupTwo() {
    ...
    popupCard.querySelector('.popup-text').innerHTML = pets[activeOrderTwo].description;
    popupCard.querySelector('.age').innerHTML = pets[activeOrderTwo].age;
    popupCard.querySelector('.inoc').innerHTML = pets[activeOrderTwo].inoculations;
    popupCard.querySelector('.diseas').innerHTML = pets[activeOrderTwo].diseases;
    popupCard.querySelector('.parasite').innerHTML = pets[activeOrderTwo].parasites;
}
...
function createPopupThree() {
    ...
    popupCard.querySelector('.popup-title').innerHTML = pets[activeOrderThree].name;
    popupCard.querySelector('.popup-name').innerHTML = pets[activeOrderThree].breed;
    popupCard.querySelector('.popup-text').innerHTML = pets[activeOrderThree].description;
    popupCard.querySelector('.age').innerHTML = pets[activeOrderThree].age;
    popupCard.querySelector('.inoc').innerHTML = pets[activeOrderThree].inoculations;
    popupCard.querySelector('.diseas').innerHTML = pets[activeOrderThree].diseases;
    popupCard.querySelector('.parasite').innerHTML = pets[activeOrderThree].parasites;
}
...
console.log(pets[activeOrderOne].img);
console.log(pets[activeOrderOne].name)